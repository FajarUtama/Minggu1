...
<script src="../Style/navbar.js"></script>
  ...
  <p align="center"><i><b>Silahkan Konfirmasi Pemesanan Anda Dibawah Ini<b></i></p>
      ...
      if(isset($_GET['id'])) {
          ...
          $sql = "SELECT * from pubgm WHERE id=".$_GET['id'];
          ...
          //echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
           ...
           <div class="content">
              ...
              <div class="row">
              <div class="col-25">
                  <img src="../pubgm/'.$row['image'].'" alt="Terjadi Kesalahan Saat Memuat Gambar" width="220" height="190"></div>  
      ...
      <div class="container">
        ...
        <div class="col-751">
          <input type="text" id="variant" name="variant" value="PUBGM">
        </div>
        <div class="col-251">
