          ...
          <td>
            ...
            if ($conn->connect_error) {
              ...
              if ($result->num_rows > 0) {
                ...
                echo '
                <div class="gallery">
                  <div class="variant"><a target="_blank" href="azur-lane-order.php?id='.$row['id'].'"><font size="4">'.$row['variant'].'</font></a></div>
                  <a target="_blank" href="azur-lane-order.php?id='.$row['id'].'"><img src="../Azur_Lane/'.$row['image'].'" alt="Terjadi Kesalahan Saat Memuat Gambar"></a>
                  <div class="price">Rp.'.$row['price'].',00;-</div>
                  <form method="post" target="_blank" action="azur-lane-order.php?id='.$row['id'].'">
                  </form>
                  </div> 
                  </div>
                </div>
