...
<script src="../Style/navbar.js"></script>
  ...
  <p align="center"><i><b>Silahkan Konfirmasi Pemesanan Anda Dibawah Ini<b></i></p>
      ...
      if(isset($_GET['id'])) {
          ...
          $sql = "SELECT * from mobile_legends WHERE id=".$_GET['id'];
          ...
          //echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
           ...
           <div class="content">
              ...
              <div class="row">
              <div class="col-25">
                  <img src="../Mobile_Legends/'.$row['image'].'" alt="Terjadi Kesalahan Saat Memuat Gambar" width="220" height="190"></div>  
      ...
      ?>
      <br><br>
      <form action="mobile-legends-order.php">
      <div class="container">
        <div class="row">
          <div class="col-25">
        ...
        <div class="col-751">
          <input type="text" id="variant" name="variant" value="Mobile Legends">
        </div>
        <div class="col-251">
